...
public class insert extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, 350, 70));
        ...
        prosesPengurutan.setFont(new java.awt.Font("HP Simplified Hans", 0, 16)); // NOI18N
        ...
        p8.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(44, 62, 80), 1, true), "Result", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("HP Simplified Hans", 0, 20), new java.awt.Color(44, 62, 80))); // NOI18N
        p8.setPreferredSize(new java.awt.Dimension(420, 140));
        p8.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        test1.setFont(new java.awt.Font("HP Simplified Hans", 0, 24)); // NOI18N
        test1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        p8.add(test1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 250, 230));

        jPanel2.add(p8, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 110, 290, 280));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 950, 480));
    ...
    private void sortMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sortMouseClicked
        // TODO add your handling code here:
        if (tfdata1.getText().equals("") || tfdata2.getText().equals("") || tfdata6.getText().equals("") || tfdata3.getText().equals("") || tfdata4.getText().equals("") || tfdata5.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Masukkan Data!", "Kesalahan", JOptionPane.ERROR_MESSAGE);
        } else {
            ...
            int i, curIn; // deklarasi variabel
            for (curIn = 1; curIn < data.length; curIn++) {
                int temp = data[curIn];
                i = curIn; //index 
                // perulangan untuk menggeser
                while (i > 0 && data[i - 1] >= temp) { // menjadi desc ketika <=temp 
                    data[i] = data[i - 1];
                    i--; // descremen
                }
                data[i] = temp; //penyisipan
