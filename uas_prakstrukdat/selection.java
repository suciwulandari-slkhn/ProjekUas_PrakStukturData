...
//            int awal, i, min; // deklarasi variabel
//            for (awal = 0; awal < dataLength - 1; awal++) { //perulangan yang memposisikan terkecil dikiri
//                min = awal; //nilai terkecil disimpan di awal
//                for (i = awal + 1; i < dataLength; i++) { // Perulangan index sampe nElemen, diincremen
//                    if (data[i] < data[min]) { // batas penelusuran
//                        min = i; // update nilai min
//                    }
//
//                }
//                swap(awal, min); // menukar awal, dgn min
//Sorting
            for (int i = 0; i < 6; i++) {
                int min = i;
                for (int j = i + 1; j < 6; j++) {
