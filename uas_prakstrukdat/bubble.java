...
public class bubble extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 10, 280, 70));
        ...
        if (tfdata1.getText().equals("") || tfdata2.getText().equals("") || tfdata3.getText().equals("") || tfdata4.getText().equals("") || tfdata5.getText().equals("") || tfdata6.getText().equals("")) {
            ...
            while (n < dataLength) {
                for (int i = 1; i < dataLength; i++) {
                    if (data[i - 1] > data[i]) { // menjadi desc ketika < data
                        int temp = data[i];
                        data[i] = data[i - 1];
                        data[i - 1] = temp;
                    }
                ...
                System.out.println("");
                prosesPengurutan.append("\n"); // method appen itu ada pada class StringBuffer pada Library java.lang
...
//                    switch (i) {
//                        case 1:
//                            result1.setText(String.valueOf(data[0]) + " - "
...
//                            break;
//                        case 2:
//                            result2.setText(String.valueOf(data[0]) + " - "
//                                    + String.valueOf(data[1]) + " - "
//                                    + String.valueOf(data[2]) + " - "
//                                    + String.valueOf(data[3]) + " - "
//                                    + String.valueOf(data[4]) + " - "
...
//                            break;
//                        case 3:
//                            result3.setText(String.valueOf(data[0]) + " - "
//                                    + String.valueOf(data[1]) + " - "
//                                    + String.valueOf(data[2]) + " - "
//                                    + String.valueOf(data[3]) + " - "
//                                    + String.valueOf(data[4]) + " - "
...
//                            break;
// case 4:
//                            result4.setText(String.valueOf(data[0]) + " - "
//                                    + String.valueOf(data[1]) + " - "
//                                    + String.valueOf(data[2]) + " - "
//                                    + String.valueOf(data[3]) + " - "
//                                    + String.valueOf(data[4]) + " - "
...
//        System.out.println(" ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bubble.class
